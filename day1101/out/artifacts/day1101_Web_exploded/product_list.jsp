...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <div class="col-md-2">
        <a href="/day1101/getProductById?id=2">
            <img src="products/1/cs10002.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/day1101/getProductById?id=2" style='color:green'>眼镜</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>

    <div class="col-md-2">
        <a href="/day1101/getProductById?id=3">
            <img src="products/1/cs10003.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/day1101/getProductById?id=3" style='color:green'>包</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>

    <div class="col-md-2">
        <a href="/day1101/getProductById?id=4">
            <img src="products/1/cs10004.jpg" width="170" height="170" style="display: inline-block;">
        </a>
        <p><a href="/day1101/getProductById?id=4" style='color:green'>手机</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
    <div class="col-md-2">
