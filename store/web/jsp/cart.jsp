    ...
    <c:if test="${not empty cart.map}">
        ...
        <div style="margin-right:130px;">
            ...
            <div style="text-align:right;margin-top:10px;margin-bottom:10px;">
                <a href="javascript:void(0)" id="clear" class="clear" onclick="removeAllFromCart()">清空购物车</a>
...
<script type="text/javascript">
    ...
    function removeAllFromCart(clear) {
        if (confirm("您确定清空购物车吗?")) {
            <%--alert(${pageContext.request.contextPath}/cart?method=clear);--%>
